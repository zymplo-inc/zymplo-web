      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-8">
        ...
        <div className="grid md:grid-cols-[1.2fr_1fr] gap-6 lg:gap-10 items-stretch">
          ...
          <div className="bg-ink text-paper rounded-3xl p-6 sm:p-8 shadow-soft flex flex-col justify-between">
            ...
            <a href={`https://wa.me/${country.slug === 'br' ? '5511925697328' : '12027718788'}?text=${encodeURIComponent(country.cta.primary)}`} className="mt-6 inline-flex items-center justify-center gap-2 w-full px-6 py-3.5 rounded-full font-extrabold text-base bg-turquesa text-white hover:bg-turquesa-dark transition">
